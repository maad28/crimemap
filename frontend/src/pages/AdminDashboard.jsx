...
const styles = {
  ...
  header:          { background:'#1a1a1a', padding:'14px 24px', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:10 },
  ...
  statsGrid:       { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(130px, 1fr))', gap:'12px', padding:'20px 24px 0' },
  ...
  tabs:            { display:'flex', alignItems:'center', gap:'4px', padding:'16px 24px 0', flexWrap:'wrap' },
  ...
  tableWrapper:    { background:'#fff', borderRadius:'12px', overflowX:'auto', boxShadow:'0 1px 4px rgba(0,0,0,.06)' },

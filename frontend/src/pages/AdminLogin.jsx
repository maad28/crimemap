//Users/mac/crimemap/frontend/src/pages/AdminLogin.jsx
    ...
    <div style={styles.wrapper}>
      <div style={styles.card}>
        <div style={styles.iconWrap}>
          <Lock size={28} color="#1a1a1a" strokeWidth={1.5}/>
        </div>
        <div style={styles.title}>Panel Superadmin</div>
...
const styles = {
  wrapper:  { height:'100dvh', display:'flex', alignItems:'center', justifyContent:'center', background:'#f5f5f5' },
